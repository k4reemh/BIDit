  ...
  return (
    <main className="admin">
      <div className="acct-head">
        <div className="adm-nav"><Link to="/admin/sellers" className="active">Sellers</Link> <span>·</span> <Link to="/admin/orders">Orders</Link> <span>·</span> <Link to="/admin/shipments">Shipping</Link> <span>·</span> <Link to="/admin/users">Accounts</Link></div>
