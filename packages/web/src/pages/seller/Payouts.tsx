  ...
  return (
    <>
      ...
      <div className="card acct-card split">
        ...
        <p className="muted acct-note">On every shipped sale you keep <b>95%</b>. The remaining <b>5%</b> splits into a <b>4%</b> <b className="accent">$BID</b> buyback and <b>1%</b> to a community treasury for buyer protection. Every item that ships pumps the token.</p>
      </div>
